...
Flash.ScaleDegree.noteRangeProperties = function(clef) {
...
Flash.ScaleDegree.noteRangeProperties.table = {
	0: {
		base_index: [1, 6, 4, 2],
		base_octave: [4, 3, 3, 4],
		upper_index: [4, 6, 1, 3],
...
Flash.ScaleDegree.keySignatureAccidentals = function (key, index) {
	var keysig, accidental;
	if(key === undefined) {
		key = "C";
	}
	keysig = Flash.ScaleDegree.keySignatureAccidentals.table[key];
	accidental = keysig[index];
	return accidental;	
}

//all arrays are [0] = "C_"
Flash.ScaleDegree.keySignatureAccidentals.table = {
	"C": ["","","","","","",""],
	"C#": ["#","#","#","#","#","#","#"],
	"Cb": ["b","b","b","b","b","b","b"],
	"D": ["#","","","#","","",""],
