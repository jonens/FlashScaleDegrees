...
/* constructor */
Flash.ScaleDegree.StatusView = function (){		
	var i, lives_paper,
		status_paper,
		box,
		hit_paper,
...
Flash.ScaleDegree.StatusView.prototype.displayInputLabels = function (btnId_array, lbl_array) {
...
Flash.ScaleDegree.StatusView.prototype.displayTime = function (timer_id, timeOut){	
	var prefix = "00:";
...
Flash.ScaleDegree.StatusView.prototype.displayLevel = function (level_id, lvl){
	var levelStr = "" + lvl;	
...
Flash.ScaleDegree.StatusView.prototype.displayPoints = function (points_id, pts, att){
...
/** @param string percent_id The html element that displays the percent
	@param number pts The total points accumulated so far in the game
	@param number att The number of attempts so far in the game */
Flash.ScaleDegree.StatusView.prototype.displayPercent = function (percent_id, pts, att){
	var percent = (att > 0) ? Math.round(pts/att * 100) : 0;
	var percentStr = "" + percent + "%";
	$(percent_id).html(percentStr);
}

Flash.ScaleDegree.StatusView.prototype.displayScore = function (score_id, score){
	var scoreStr = "" + score;
	$(score_id).html(scoreStr);
}

Flash.ScaleDegree.StatusView.prototype.displayHiScore = function (hiscore_id, hiscore){
